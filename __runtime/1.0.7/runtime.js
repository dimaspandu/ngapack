  ...
  typeof window !== "undefined" ? window : this,
  {
    ...
    "&::entry.js": [
      function(require, exports, module) {
        ...
        async function runAllTests() {
          ...
          try {
            ...
            // -----------------------------------------------------------------------
            // 5. Test fully-qualified Microfrontend resource with namespace (Microfrontend)
            // -----------------------------------------------------------------------
            var somewhere = await require("https://www.microfrontends.com/resources/somewhere.js/<HTTP>/MicroFrontend");
            runTest(
              "Somewhere Dynamic Module (Microfrontend)",
              somewhere.default,
              "Hello! I'm from somewhere!",
              true // The end of all tests
            );
      ...
      },
      {
        ...
        "https://www.microfrontends.com/resources/somewhere.js/<HTTP>/MicroFrontend": "MicroFrontend::resources/somewhere.js/<HTTP>" // Or it could be "MicroFrontend::resources/somewhere.js/<HTTP>/"
      }
    ],
    // Greetings module
    "&::greetings.js": [
