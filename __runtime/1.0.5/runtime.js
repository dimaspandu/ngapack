      ...
      function(require, exports, module) {
        ...
        async function runAllTests() {
          ...
          try {
            ...
            // Test dynamic CSS module using namespace (that is DynamicCSS)
            const styles = await require("./dynamic/styles.css/<HTTP>/DynamicCSS");
            runTest(
            ...
            const somewhere = await require("https://www.microfrontends.com/resources/somewhere.css/<HTTP>/Somewhere");
            runTest(
