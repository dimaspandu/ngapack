...
// --- Test 9.1: Side-effect only imports using backticks ---
runTest(
  "Side-effect only imports using backticks",
  "import `./global.js`; import `./styles.css`;",
  "require(`./global.js`); require(`./styles.css`);"
);

// --- Test 9.2: Side-effect only imports using backticks with template expressions ---
runTest(
  "Side-effect only imports using backticks with template expressions",
  "const something = \"3\"; import `./${something}/global.js`; import `./${something}/styles.css`;",
  "const something = \"3\"; require(`./${something}/global.js`); require(`./${something}/styles.css`);"
);
...
const counter = require(\`\$\{baseURL\}/components/counter.js\`);
  `
);
...
// --- Test 17.1: Dynamic Import with .http(namespace): contd ---
runTest(
...
// --- Test 26: Dynamic Import CSS with import attributes and a namespace ---
runTest(
  ...
  `,
  `
  const localGlobalsSheet = await require("https://www.mock.com/styles/globals.css").http("MainFrontend");
  `
);

export default {
  name: "transpileESMToCJS.test.js",
  results: testResults
};
